                    ...
                    <div className='section_div'>
                        <div className='card_div'>
                            ...
                            <div className='yourCrad_img'>
                                ...
                                <img className='plussymbol' src="/images/plusInCircle.png" alt="" />
                                <button className='newcardbutton' ><Link className='createnewcardlink' to='createCard'>Create A New Card</Link></button>
                                </div>
